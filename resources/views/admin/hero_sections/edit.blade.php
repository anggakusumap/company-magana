                ...
                <form method="POST" action="{{route('admin.hero_sections.update', $hero_section)}}"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="subheading" class="block mt-1 w-full" type="text" name="subheading"
                                      value="{{$hero_section->subheading}}" required
                                      autofocus autocomplete="subheading"/>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="achievement" class="block mt-1 w-full" type="text" name="achievement"
                                      value="{{$hero_section->achievement}}" required
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_video" class="block mt-1 w-full" type="text" name="path_video"
                                      value="{{$hero_section->path_video}}" required
                                      autofocus autocomplete="path_video"/>
